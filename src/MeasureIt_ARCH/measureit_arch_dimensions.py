        ...
        if 'DimensionGenerator' in context.object:
            ...
            if len(dimGen.wrapper) > 0 and dimGen.active_index < len(dimGen.wrapper):
                ...
                if activeWrapperItem.itemType in field_types:
                    ...
                    txtAddOp.propPath = 'bpy.context.active_object.DimensionGenerator.{}[{}].textFields'.format(
                        activeWrapperItem.itemType, idxString)
                    ...
                    if dimGen.show_dimension_fields:
                        ...
                        propPath = 'bpy.context.active_object.DimensionGenerator.{}[{}].textFields'.format(
                            activeWrapperItem.itemType, idxString)
